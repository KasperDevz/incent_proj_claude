    ...
    <div className="min-h-screen bg-slate-50 p-8">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          {[
            { icon: BarChart2, label: "ยอดขาย YTD", value: "–", desc: "กำลังพัฒนา" },
            { icon: Target, label: "Goal Progress", value: "–", desc: "กำลังพัฒนา" },
        ...
        <div className="rounded-xl border bg-white p-6 shadow-sm text-center text-slate-400 py-16">
          <p className="text-sm">Coming soon: sales totals, monthly chart, goal step progress</p>
        </div>
      </div>
    </div>
  )
